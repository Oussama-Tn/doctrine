...
class PurchaseOrderProduct
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\PurchaseOrder", inversedBy="purchaseOrderProducts")
     * @ORM\JoinColumn(nullable=false)
     */
    private $purchaseOrder;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Product", inversedBy="purchaseOrderProducts")
     * @ORM\JoinColumn(nullable=false)
     */
    private $product;
